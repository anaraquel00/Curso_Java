...
public static void main(String[] args) {
		...
		case "feveiro" -> System.out.println("28 dias");
...
//		
//		if(acordeiCedo) {
//			tomarCafe = true;			case "abril","junho","setembro","setembro","novembro",->syso  
